...
const _myGitHubAccessToken = "073dd25e5f7c804e36d53095f24da95fc036db71";
const _GITHUBAPI_USER_ENDPOINT = `https://api.github.com/users/mathcodes`;
const _GITHUBAPI_USERSEARCH_ENDPOINT = `https://api.github.com/users/search?q=mathcodes`
...
`
   ...
   console.log(`'${_filename}' complete... SUCCESS!!!`)
};
